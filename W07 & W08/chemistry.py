...
def compute_molar_mass(symbol_quantity_list, periodic_table):
    ...
    quantity_list = []
    current_index = 0
    while current_index < len(symbol_quantity_list):
        symbol_list[current_index] = symbol_quantity_list[current_index]
        quantity_list[current_index] = symbol_quantity_list[current_index]
        print(quantity_list)
        print(symbol_list)
...
def main():
    ...
    sample_mass = input('Enter the mass of the sample.')
    #output grams/mole
    #output moles
...
molecule = "H2O"
#print(table)
symbol_quantity_list = parse_formula(molecule,table)
...
current_index = 0
while current_index < len(symbol_quantity_list):
    symbol_list.append(symbol_quantity_list[current_index])
    quantity_list.append(symbol_quantity_list[current_index])
    print(quantity_list)
    print(symbol_list)
    current_index += 1

quantity_list = filter(lambda i: not str.symbol_quantity_list(i),x)
